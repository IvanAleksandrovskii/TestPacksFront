    ...
    <div className="max-w-5xl mx-auto"> {/* Увеличили max-w-4xl до max-w-5xl */}
        ...
        <div className="mb-6 text-lg leading-relaxed">
            ...
            <p>
                ...
                <strong>«Наборы»</strong> и нажмите <strong>«Создать набор»</strong>.
            ...
            <p>Чтобы создать свой тест, перейдите в раздел <strong>«Тесты»</strong> и нажмите на кнопку <strong>«Создать тест»</strong>.</p>
            <br />
            <p>
            ...
            <br />
            <p className="italic">
                Если приложение постоянно выдает ошибку при загрузку данных, 
                нажмите на три точки в правом верхнем углу экрана, далее "Обновить страницу".
                У Телеграм браузера иногда подвисает старый кэш.
            </p>
            <br />
            <p className="mb-12">
