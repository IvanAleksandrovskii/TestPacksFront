...
function Home() {
    ...
    <div className="max-w-5xl mx-auto"> {/* Увеличили max-w-4xl до max-w-5xl */}
        ...
        <div className="mb-6 text-lg leading-relaxed">
            ...
            <br />
            <p><em> 
                <strong>Кнопки навигации</strong> находятся в нижней части экрана. В меню создания или удаления тестов 
                и наборов доступна кнопка <strong>«Назад»</strong>, с помощью которой вы всегда можете вернуться в главное меню. 
            </em></p> 
            <br />
