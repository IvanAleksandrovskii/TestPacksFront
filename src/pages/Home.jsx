    ...
    <div className="max-w-5xl mx-auto"> {/* Увеличили max-w-4xl до max-w-5xl */}
        ...
        <div className="mb-6 text-lg leading-relaxed">
            ...
            <p><em> 
                ...
                тестов и наборов, а так же из подробностей прохождения теста 
                происходит через кнопку <strong>«Назад» </strong>в левом верхнем углу экрана.
            </em></p> 
            <br />
            ...
            <p>
                Результаты и доступны во вкладке "Прохождения" в правом нижнем углу экрана.
            </p>
            <br />
            <p className="mb-12">
